...
function agregarMetodoCalculoDescuento (producto) {
  ...
  const calcularPrecioDescuento =function(){
    const newPrecio = this.precio - (this.precio * this.porcentajeDeDescuento);
    this.precio = newPrecio;   
    return this.precio;
  }

  //producto = {...producto, calcularPrecioDescuento}
  Object.assign(producto, {'calcularPrecioDescuento' : calcularPrecioDescuento });
